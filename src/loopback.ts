/**
 * Loopback trust fence for the token-usage stats HTTP route: socket address,
 * Host header, and browser same-origin markers. Self-contained copy of the
 * pattern used across DSH web plugins (no cross-package dependency).
 *
